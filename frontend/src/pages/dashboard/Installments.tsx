...
export default function Installments() {
  ...
  const handleEnableAutoDebit = async (inst: any) => {
    try {
      ...
      toast.error('Failed to initialize auto-debit');
    }
  };
        ...
        {installments?.map((inst: any, i: number) => {
          ...
          return (
            ...
            >
              ...
              <div className="mb-8 grid grid-cols-3 gap-0 overflow-hidden rounded-xl border border-border bg-slate-50/50">
                ...
                <div className="p-4 text-center border-r border-border bg-primary/5">
                  <p className="text-[10px] font-bold uppercase tracking-widest text-primary mb-1">Paid</p>
                  <p className="text-sm font-bold text-primary">{formatCurrency(amountPaid)}</p>
                </div>
